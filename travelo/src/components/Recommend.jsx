...
//             image: Destination2,
//             title: "Thailand",
//             subTitle:"Thailand is a Southeast Asia counyry. It's known fpr",
//             cost: "54,200",
//             duration: "Approx 2 night trip",
//         },
//         {
...
//             image: Destination4,
//             title: "New Zealand",
//             subTitle:"New Zealamd is a island country in the",
//             cost: "24,100",
...
//                     <img src={destination.image} alt="Destination Images" />
      ...
      <div className="destinations">
        {data.map((destination, index) => (
          <div className="destination" key={index}>
            <img src={require(`../assets/${destination.image}`)} alt={destination.title} />
            <h3>{destination.title}</h3>
            <p>{destination.subTitle}</p>
            <div className="info">
              <div className="services">
